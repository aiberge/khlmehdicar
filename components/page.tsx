...
export function HomePage() {
  ...
  const handleReservation = (car: Car) => {
    ...
    const whatsappUrl = `https://wa.me/212672351130?text=${encodeURIComponent(message)}`;
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
            ...
            <div className="lg:col-span-2 bg-white rounded-lg shadow-lg overflow-hidden">
              <div className="aspect-[16/9] w-full">
                <iframe
                  src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d2045.8074830482067!2d-5.93234285669788!3d35.516221357627366!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0xd0b9100490546af%3A0xe5ab45764feeb4c5!2z2YjZg9in2YTYqSDZg9ix2KfYoSDYp9mE2LPZitin2LHYp9iqIEtITCBDQVIgU0FSTA!5e0!3m2!1sfr!2sma!4v1732526227434!5m2!1sfr!2sma"
                  width="100%"
                  height="100%"
                  style={{ border: 0 }}
                  allowFullScreen
